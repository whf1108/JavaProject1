...
public class OrderServiceImpl implements OrderService {
    ...
    public PayRecordDto queryPayResult(String payNo) {
        ...
        //调用支付宝的接口查询支付结果
        PayStatusDto payStatusDto = queryPayResultFromAlipay(payNo); // 因为要返回这个payStatusDto，所有除了sdk，里面还得写个
    ...
    public PayStatusDto queryPayResultFromAlipay(String payNo){
        ...
        payStatusDto.setOut_trade_no(payNo); // 我们的交易号
    ...
    public void saveAliPayStatus(PayStatusDto payStatusDto){
        ...
        //如果数据库支付的状态已经是成功了，不再处理了。被动通知那里可能已经完成了
    ...
    public void notifyPayResult(MqMessage message) {
        ...
        //创建一个持久化消息
        // jsonString.getBytes(StandardCharsets.UTF_8) 是变为字节数组
