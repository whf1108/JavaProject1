...
public class BigFilesController {
    ...
    @PostMapping("/upload/checkfile")  // 只有这个视频才检查了，图片好像在插入时，检查了。前端是怎么得到md5的？
    ...
    public RestResponse uploadchunk(@RequestParam("file") MultipartFile file,  // 这里为什么不用@RequestPart
                                    @RequestParam("fileMd5") String fileMd5,  // 这里的md5值不是每个块的md5值，应该是整个文件的md5值！！！！！！
        ...
        //文件路径
        String localFilePath = tempFile.getAbsolutePath();  // 本机服务器的临时文件怎么没有删除啊！
