...
public class MediaFileServiceImpl implements MediaFileService {
    ...
    public UploadFileResultDto uploadFile(Long companyId, UploadFileParamsDto uploadFileParamsDto, String localFilePath,String objectName) {
        ...
        // 感觉要校验MD5，下载上传的文件，然后与 String fileMd5 = getFileMd5(new File(localFilePath)) 这个md5比较
    ...
    @Override
    public RestResponse<Boolean> checkChunk(String fileMd5, int chunkIndex) {  // 分块没有存在数据库中
    ...
    public RestResponse mergechunks(Long companyId, String fileMd5, int chunkTotal, UploadFileParamsDto uploadFileParamsDto) {
        ...
        //先下载合并后的文件
        File file = downloadFileFromMinIO(bucket_video, objectName);   // 下载下来的临时文件怎么没有清理！！！
        try(FileInputStream fileInputStream = new FileInputStream(file)){
            //计算合并后文件的md5
    ...
    public File downloadFileFromMinIO(String bucket,String objectName){
        ...
        try{
            InputStream stream = minioClient.getObject(GetObjectArgs.builder()
                    ...
                    .build());
            //创建临时文件
            minioFile=File.createTempFile("minio", ".merge"); // new file()
