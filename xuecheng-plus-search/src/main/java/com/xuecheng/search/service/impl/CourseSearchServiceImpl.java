...
public class CourseSearchServiceImpl implements CourseSearchService {
    ...
    public SearchPageResultDto<CourseIndex> queryCoursePubIndex(PageParams pageParams, SearchCourseParamDto courseSearchParam) {
        ...
        searchSourceBuilder.fetchSource(sourceFieldsArray, new String[]{});  // 得到指定字段，排除指定字段
        ...
        highlightBuilder.preTags("<font class='eslight'>");  //  这两个之前没有
        highlightBuilder.postTags("</font>");  // 这两个之前没有
        //设置高亮字段
        highlightBuilder.fields().add(new HighlightBuilder.Field("name")); //为什么又要new HighlightBuilder.Field("name")？？？
